...
> [!Note]
> If there is any issues in loading the data or visual then follow either of the two Method:<br>
Method 1: 
Load the excel dataset named **Classic Model Dataset.xlsx** in Power BI and then try to open again the pbix file
